...
public class ImageDeleteScheduling {
	...
	@Scheduled(cron = "0,30 0 0 1 * *") // 시계 초 단위가 0, 30인 경우 수행(테스트용)
	public void scheduling() {
		
		log.info("스케쥴러 동작!");
		
		// DB, 서버 파일 목록 비교 후 DB에 없는 서버 이미지 파일 삭제
		...
		// 배열 내용 복사 (깊은 복사)
		// System.arraycopy(복사할배열, 몇번인덱스부터복사할지, 새로운배열, 새로운배열의몇번인덱스부터넣을지, 복사를어디까지할건지)
